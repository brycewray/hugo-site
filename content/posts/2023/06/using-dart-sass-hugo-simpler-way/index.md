...
then
  ...
  echo "Failed to detect Dart Sass v.${DART_SASS_VERSION} --- installing it...\n"
  ...
  tar -xvf dart-sass-${DART_SASS_VERSION}-${DART_SASS_ARCH}.tar.gz
  rm -rf ../bin/dart-sass
  mv dart-sass ../bin
  sass --embedded --version
  rm -rf dart-sass-${DART_SASS_VERSION}-${DART_SASS_ARCH}.tar.gz
fi
