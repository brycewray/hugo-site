...
Moreover, as I mentioned in [another, later article](/posts/2023/05/cloudflare-pages-more-attractive-home-hugo-sites/), it turns out that [Cloudflare Pages](https://pages.cloudflare.com) will perform a sufficiently deep clone if you preface your build command with `git fetch --unshallow` followed by the `&&` concatenation operator; *e.g.*:\
...
```js{filename="gitinfo.js" bigdiv=true}
