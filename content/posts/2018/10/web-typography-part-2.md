...
<tr><td class="td30">San Francisco</td><td class="td70">{{< img src="Sys_font_stack_San_Francisco_684x104.png" alt="San Francisco typeface" simple=true source="Cloudinary" >}}</td></tr>
<tr><td class="td30">Segoe UI</td><td class="td70">{{< img src="Sys_font_stack_Segoe_UI_684x104.png" alt="Segoe UI typeface" simple=true source="Cloudinary" >}}
...
<tr><td class="td30">Helvetica Neue</td><td class="td70">{{< img src="Sys_font_stack_Helvetica_Neue_680x104.png" alt="Helvetica Neue typeface" simple=true source="Cloudinary" >}}
<tr><td class="td30">Lucida Grande</td><td class="ctr td70">{{< img src="Sys_font_stack_Lucida_Grande_680x104.png" alt="Lucida Grande typeface" simple=true source="Cloudinary" >}}
</table>
