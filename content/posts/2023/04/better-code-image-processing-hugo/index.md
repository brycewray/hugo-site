...
{{< img src="my-pet-cat_3264x2448.jpg" alt="Photo of a cat named Shakespeare sitting on a window sill" imgproc="local" holder="LQIP" filter="box" >}}<!-- keep as `local` since post is about that -->
