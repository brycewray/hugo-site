...
<div class="yellowBox"><p><strong>Note, 2020-07-17</strong>: I originally neglected to mention, here at least (although <a href="https://twitter.com/BryceWrayTX/status/1125567578376683525" target="_blank" rel="noopener">I <strong>did</strong> mention it a couple of days later on Twitter</a>, one critical aspect of my regaining trust in Ulysses: some great help I received from the nice folks at Ulysses Support. They had me send various iCloud-related logs from all my Ulysses-using devices (Mac, iPhone, and iPad). Their analysis concluded that my iCloud setup (mainly on the Mac) &ldquo;might be corrupted in general since several programs utilizing iCloud Drive have trouble synchronizing.&rdquo; They suggested I completely log off, then log back into, iCloud on all the devices. That was over a year ago, and I haven&rsquo;t had a whit of trouble with Ulysses ever since on any of the devices. <strong>Thanks to</strong> <a href="https://gordonansell.com/ulysses-icloud-sync-problem-further-information" target="_blank" rel="noopener"><strong>Gordy Ansell</strong> for very nicely raising the question</a>, and I apologize for leaving you folks hanging all this intervening time.</p></div>
