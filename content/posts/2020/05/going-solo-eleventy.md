...
<div class="yellowBox"><p><strong>Update, 2020-05-25</strong>&nbsp;.&nbsp;.&nbsp;.<br />
The next day, I switched to a <strong>real</strong> image-processing plugin&mdash;<code>eleventy-plugin-local-respimg</code> by <a href="https://github.com/Snugug" target="_blank" rel="noopener">Sam Richard</a>&mdash;thus replacing <code>imgxfm.js</code>. However, while this plugin obviously was superior to my script, my <a href="https://twitter.com/BryceWrayTX/status/1263641169889824769" target="_blank" rel="noopener">later switch</a> from LazySizes to <a href="https://github.com/verlok/lazyload" target="_blank" rel="noopener">LazyLoad</a> for lazy-loading made it <a href="https://github.com/verlok/vanilla-lazyload/issues/461#issuecomment-633234705" target="_blank" rel="noopener">necessary</a> to revert to <code>imgxfm.js</code>, at least for now. (That said: I still extend a big thanks to <a href="https://github.com/rickthehat" target="_blank" rel="noopener">Rick G.</a> for <a href="https://github.com/chromeos/static-site-scaffold-modules/issues/16#issuecomment-626250527" target="_blank" rel="noopener">helping me</a> get past earlier issues with Mr. Richard&rsquo;s excellent plugin.)</p></div>
