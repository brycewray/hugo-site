...
{{% lazypictCapt %}}Ulysses’s Quick Export feature: the only way you can derive a true, standalone, visible Markdown&nbsp;file from one of its native, proprietary-format&nbsp;files.{{% /lazypictCapt %}}
...
{{% lazypictCapt %}}Ladies and gentlemen, the winner (for now): iA&nbsp;Writer.{{% /lazypictCapt %}}
