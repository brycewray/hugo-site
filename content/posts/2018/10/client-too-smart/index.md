...
{{< imgh src="Outlook_full_img_600x940.png" alt="Fancy email from ad agency with styled text and artwork" >}}

. . . this is what actually gets through the desktop version of Outlook:

{{< imgh src="Outlook_full_no_imgs_600x940.png" alt="Email with many blank spaces because email client blocks images" >}}
