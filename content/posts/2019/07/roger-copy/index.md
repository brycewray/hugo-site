...
{{< imgh-colors src="Working_Copy_scr_cap_01_2048x1536.png" alt="iPad screen capture: Working Copy on the left, iA Writer on the right" width=2048 height=1536 >}}
...
{{< imgh-colors src="Working_Copy_scr_cap_02_2048x1536.png" alt="iPad screen capture: Working Copy display of the local Git repository on the device" width=2048 height=1536 >}}
...
{{< imgh-colors src="Working_Copy_scr_cap_04_2048x1536.png" alt="iPad screen capture: Working Copy display showing a push has gone to Bitbucket" width=2048 height=1536 >}}
...
{{< imgh-colors src="Working_Copy_scr_cap_07_2048x1536.png" alt="iPad screen capture: Working Copy display showing that the master branch is synchronized with the three remote repositories" width=2048 height=1536 >}}
...
{{< imgh-colors src="Working_Copy_scr_cap_11_2048x1536.png" alt="iPad screen capture: Working Copy display showing its built-in text editor" width=2048 height=1536 >}}
