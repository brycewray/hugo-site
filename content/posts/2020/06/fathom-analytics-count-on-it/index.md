...
imgs:
- fathom-analytics_1420x1025.png
---
...
\
<strong class="red">Update, 2023-11-03</strong>: Due to this site's typically low traffic volume, I have since ceased being a customer of Fathom Analytics **but**: (a.) my opinions about this provider remain uniformly positive; **and** (b.) I retain an affiliate-only account, so [**the offer above still applies** in case you wish to give Fathom a try](https://usefathom.com/ref/ZKHYWX).
{.box}
...
- **Questionable data** --- Netlify Analytics doesn't give you any way to block your own traffic. So, if you're sitting there trying to figure out something about your own site's appearance and thus hitting numerous pages, Netlify Analytics is counting all that. The same goes for views of your site when it's only on "[localhost](https://datatracker.ietf.org/doc/html/rfc2606#section-2)" during development. What good does having *that* data do you? And, speaking of bogus traffic&nbsp;.&nbsp;.&nbsp;.
...
![Screen capture from the Fathom Analytics “dashboard” on its live demo](fathom-analytics_1420x1025.png)
...
- **Bloat-free** --- Fathom Analytics’ *single line of code*, delivered by a [CDN](https://web.archive.org/web/20150905054800/http://www.cdnetworks.com/blog/how-content-delivery-networks-work/) with worldwide endpoints, **won't** sap your site's performance the way the more bloated Google Analytics code can.
