...
The next day, I switched to a <strong>real</strong> image-processing plugin&mdash;<code>eleventy-plugin-local-respimg</code> by <a href="https://github.com/Snugug">Sam Richard</a>&mdash;thus replacing <code>imgxfm.js</code>. However, while this plugin obviously was superior to my script, my <a href="https://twitter.com/BryceWrayTX/status/1263641169889824769">later switch</a> from LazySizes to <a href="https://github.com/verlok/lazyload">LazyLoad</a> for lazy-loading made it <a href="https://github.com/verlok/vanilla-lazyload/issues/461#issuecomment-633234705">necessary</a> to revert to <code>imgxfm.js</code>, at least for now. (That said: I still extend a big thanks to <a href="https://github.com/rickthehat">Rick G.</a> for <a href="https://github.com/chromeos/static-site-scaffold-modules/issues/16#issuecomment-626250527">helping me</a> get past earlier issues with Mr. Richard&rsquo;s excellent plugin.)</p></div>
