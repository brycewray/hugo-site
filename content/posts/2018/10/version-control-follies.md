...
In short, I’d gone from a setup in which _every_ change (no matter how tiny) involved a series of hand-typed Git commands to one in which change was no big deal. Make and save the change locally, do a commit, then do a push. Click, type in a description of what you’re changing, click, and click. Watch Netlify run with it. Bang. Life is good.

[^1]:	Albeit only fifty builds a month. Not sure whether that also means fifty commits a month. Will find out soon enough.