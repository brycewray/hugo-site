...
{{< img src="Public_Sans_selected_family_1024x1248.png" alt="Screen capture from Google Fonts showing typeface selections" phn=true proc="Cloudinary" >}}
...
{{< img src="Public_Sans_Embed_1060x1798.png" alt="Screen capture from Google Fonts showing code for embedding" phn=true proc="Cloudinary" >}}
...
![Screen capture from browser showing URL pasted into URL bar"](Public_Sans_URL_pasted_into_browser_1588x74.png "Cloudinary")
...
1.  Now, put the renamed .woff2 files in whatever location is appropriate for your website's setup, and do the normal setup you'd do to make "local" fonts work.\
\
