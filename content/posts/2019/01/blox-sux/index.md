...
{{< imgc src="screen-cap-from-Pippin-Williamson-s-page-builders-review_986x482.png" alt="Screen capture showing shortcodes from a WordPress page builder" width=986 height=482 >}}
