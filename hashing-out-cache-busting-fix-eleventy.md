...
<p class="yellowBox"><strong>Note, 2020-12-17</strong>: If you use <a href="https://netlify.com" target="_blank" rel="noreferrer noopener">Netlify</a>
, be sure you <strong>turn off</strong> its post-processing of your CSS, which I’ve found can bollix up this method. <em>(My repos’ code already handles such processing anyway.)</em> You can do it either through the Netlify GUI (<strong>Build &amp;deploy</strong> &gt;<strong>Post processing</strong>
