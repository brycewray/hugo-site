...
<p class="lazypicturecaption"><img class="imgCover" src="/images/Ulysses_export_to_Markdown_750x528.jpg" alt="Screen capture of Quick Export feature of Ulysses app" />Ulysses’s Quick Export feature: the only way you can derive a true, standalone, visible Markdown&nbsp;file from one of its native, proprietary-format&nbsp;files.</p>
...
<p class="lazypicturecaption"><img class="imgCover" src="/images/iCloud_sync-save_icon_in_Ulysses_634x265.jpg" alt="Screen capture from Ulysses showing iCloud icon, indicating ongoing sync" />When this little cloud icon (highlighted in the yellow circle) just sits and sits and sits in the Ulysses sheet synopsis and the timestamp doesn&rsquo;t change, even though you edited this file days ago on another device—Houston, we have an iCloud&nbsp;sync&nbsp;problem.</p>
...
<p class="lazypicturecaption"><img class="imgCover" src="/images/iA_Writer_on_why-left-ulysses_post_cropped_1272x620.jpg" alt="Screen capture from iA Writer app" />Ladies and gentlemen, the winner (for now): iA&nbsp;Writer.</p>
