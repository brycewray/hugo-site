...
The inaugural **[Eleventy Meetup](https://11tymeetup.dev/)** occurred earlier this week, and it was a blast. We heard interesting talks from [Eleventy](https://11ty.dev) creator Zach Leatherman and Mike Aparicio of [11ty.recipes](https://11ty.recipes) fame (and Mike's dog, too, albeit briefly). A good time was had by all. If you have the slightest interest in Eleventy, I urge you to check the [Meetup site](https://11tymeetup.dev) and sign up for the newsletter so you can be advised of future sessions.
...
![Screen capture of StatCounter’s June 2021 display of worldwide browser market share](2021-07-17_StatCounter-browser-mkt-shr_June-2021_1872x576.png "Cloudinary")
