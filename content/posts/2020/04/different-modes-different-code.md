...
<div class="yellowBox"><p><strong>Update, 2020-04-15</strong>: While I did make some progress on the Gridsome repo project in the ensuing days after first releasing this post, I think it will be a while&mdash;perhaps months&mdash;before I can make any serious headway. There are a number of things the young Gridsome still doesn&rsquo;t do that well which, while they wouldn&rsquo;t be showstoppers to others, just cause it to miss the mark where I&rsquo;m concerned. Two minor examples are <a href="https://github.com/gridsome/gridsome/issues/177">&ldquo;previous post&rdquo; and &ldquo;next post&rdquo; functionality</a> and <a href="https://github.com/gridsome/gridsome/issues/1089">directory-based URLs</a>, but there are others. <em>(In the meantime, however, <a href="/posts/2020/04/full-11ty-js-monty">I can always find other things to do</a>.)</em></p></div>
