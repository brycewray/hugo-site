...
At long last, my household has [cut the cord](https://www.fastcompany.com/90264298/traditional-tv-is-collapsing-faster-than-ever-as-q3-cord-cutting-hits-record-1-1-million). We be [streamers](https://www.digitaltrends.com/home-theater/how-to-quit-cable-for-online-streaming-video/).
...
At least, we had *all three channels* until my father was transferred to another state for several years. In that place, we had *two*-and-a-half channels: a station that carried a mixture of CBS programming and NBC programming; a station that carried almost exclusively ABC programming, except for a handful of CBS shows in daytime[^ABCCBS]; and, on those rare times when its weak signal made it to us, an affiliate of what then was [NET](https://americanarchive.org/special_collections/net-catalog) and later became [PBS](https://www.pbs.org).[^NETprog]
...
By the time I was in my twenties, satellite-delivered programming was becoming available on cable systems, which were popping up even in little towns like mine where antennae worked just fine. I still remember when my home town first got cable TV, around 1980 or so. My parents’ initial cable subscription included: the local channels (*i.e.*, the nearest network affiliates); a couple of pay channels (which you could hear but not see if you didn't subscribe to them, since the primitive system couldn't fully shut out all the signal); the "[superstations](https://web.archive.org/web/20140203161106/http://www.museum.tv/eotv/superstation.htm)" WTBS and WGN; a couple of religion-oriented channels; and a short-lived movie channel which aired only two or three hours of prime-time programming per night.
